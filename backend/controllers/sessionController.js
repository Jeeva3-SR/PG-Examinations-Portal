...
exports.previewTimetableUpload = async (req, res) => handleTimetableUpload(req, res, { commit: false });

exports.uploadTimetable = async (req, res) => handleTimetableUpload(req, res, { commit: true });

exports.commitTimetableUpload = async (req, res) => {
...
exports.getReportAssignments = async (req, res) => {
  try {
